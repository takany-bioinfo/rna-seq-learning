...
このNotebookは、**Arabidopsis thaliana** の**single-end RNA-Seq**公開データを用いて、**DEG解析**に向けたデータの前処理を行います。
...
🔗 [DEG解析例を見る](https://takany-bioinfo.github.io/rna-seq-learning/deg_01.html)